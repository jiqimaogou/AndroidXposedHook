...
public class XposedModuleTikTok implements IXposedHookLoadPackage {
    @Override
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        findAndHookMethod(
                "com.arophix.xposedhooking.DummyPerson",
                lpparam.classLoader,
                "getFullName",
                new XC_MethodHook() {
                    @Override
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        XposedBridge.log(
                                "Before ===>>> DummyPerson$getFullName is hooked: "
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        XposedBridge.log(
                                "After ===>>>  DummyPerson$getFullName is hooked: "
                                        + param.getClass().getSimpleName());
                    }
                });
        ...
        findAndHookMethod(
                ...
                new XC_MethodHook() {
                    ...
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        // this will be called before the clock was updated by the original method
                        XposedBridge.log(
                                "2 Before ===>>> DummyPerson$getFullName is hooked: "
                                        + param.getClass().getSimpleName());
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        XposedBridge.log(
                                "2 After ===>>>  DummyPerson$getFullName is hooked: "
                                        + param.getClass().getSimpleName());
